...
--   Date and Time:   21:27 Tuesday December 16, 2025
...
,p_authentication_id=>wwv_flow_imp.id(119818174703752389569)
...
wwv_flow_imp_page.create_page_plug(
 p_id=>wwv_flow_imp.id(119819723307212185812)
,p_plug_name=>'Chart'
,p_title=>'Counts for orders'
...
wwv_flow_imp_page.create_jet_chart(
 p_id=>wwv_flow_imp.id(119819723480048185813)
,p_region_id=>wwv_flow_imp.id(119819723307212185812)
,p_chart_type=>'bar'
,p_height=>'400'
...
wwv_flow_imp_page.create_jet_chart_series(
 p_id=>wwv_flow_imp.id(119819723595427185814)
,p_chart_id=>wwv_flow_imp.id(119819723480048185813)
,p_seq=>10
,p_name=>'New'
,p_data_source_type=>'TABLE'
,p_query_table=>'VW_DAILY_ORDERS'
,p_include_rowid_column=>false
,p_items_z_column_name=>'ORDER_ID'
...
wwv_flow_imp_page.create_jet_chart_axis(
 p_id=>wwv_flow_imp.id(119819723603562185815)
,p_chart_id=>wwv_flow_imp.id(119819723480048185813)
,p_axis=>'x'
,p_is_rendered=>'on'
...
wwv_flow_imp_page.create_jet_chart_axis(
 p_id=>wwv_flow_imp.id(119819723729840185816)
,p_chart_id=>wwv_flow_imp.id(119819723480048185813)
,p_axis=>'y'
,p_is_rendered=>'on'
...
unistr('// \062A\0641\0639\064A\0644 \062A\0635\062D\064A\062D AJAX'),
...
'#button-send-message {',
unistr('    background-color: #0fba4e; /* \0644\0648\0646 \0648\0627\062A\0633\0627\0628 */'),
'    border-color: #00c94a;',
'    color: white;',
'    font-weight: bold;',
...
'<!--',
'  Copy Button for Invoice ID - Unified Style',
'  Created: 2025-12-14',
'  Description:',
'    Styled to match standard APEX hot buttons with icon on the left.',
'    Clicking this button will trigger a Dynamic Action to copy the invoice ID.',
'-->',
'',
'<button type="button"',
'        class="copy-btn t-Button t-Button--hot t-Button--icon t-Button--iconLeft"',
'        data-id="#ORDER_ID#"',
'        id="button-send-message"',
'        title="Send Message Whatsapp"',
'        aria-label="Send Message Whatsapp">',
'  <span aria-hidden="true" class="t-Icon t-Icon--left fa fa-copy"></span>',
...
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(119819722836830185807)
,p_name=>'PHONE_NUM'
,p_item_sequence=>10
,p_item_plug_id=>wwv_flow_imp.id(119813454174483807656)
,p_display_as=>'NATIVE_HIDDEN'
,p_attributes=>wwv_flow_t_plugin_attributes(wwv_flow_t_varchar2(
  'value_protected', 'N')).to_clob
);
wwv_flow_imp_page.create_page_item(
 p_id=>wwv_flow_imp.id(119819722978364185808)
,p_name=>'BODY_MESS'
,p_item_sequence=>20
,p_item_plug_id=>wwv_flow_imp.id(119813454174483807656)
,p_display_as=>'NATIVE_HIDDEN'
...
wwv_flow_imp_page.create_page_da_event(
 p_id=>wwv_flow_imp.id(119819723104367185810)
,p_name=>'For send Message whatsapp'
,p_event_sequence=>20
,p_triggering_element_type=>'JQUERY_SELECTOR'
,p_triggering_element=>'#button-send-message'
,p_bind_type=>'live'
,p_execution_type=>'IMMEDIATE'
,p_bind_event_type=>'click'
);
wwv_flow_imp_page.create_page_da_action(
 p_id=>wwv_flow_imp.id(119819723261599185811)
,p_event_id=>wwv_flow_imp.id(119819723104367185810)
,p_event_result=>'TRUE'
,p_action_sequence=>10
,p_execute_on_page_init=>'N'
,p_action=>'NATIVE_JAVASCRIPT_CODE'
,p_attribute_01=>wwv_flow_string.join(wwv_flow_t_varchar2(
'var orderId = $(this.triggeringElement).data(''id'');',
...
'                var phone = data.phone || data.phone_number;',
'                var message = data.message || data.message_body;',
'                ',
'                if (phone && message) {',
'                    sendWhatsAppMessage(phone, message);',
'                } else {',
unistr('                    showError(''\0628\064A\0627\0646\0627\062A \0627\0644\0639\0645\064A\0644 \063A\064A\0631 \0645\0643\062A\0645\0644\0629'');'),
'                }',
'            } else {',
unistr('                showError(data.error || ''\062D\062F\062B \062E\0637\0623 \063A\064A\0631 \0645\0639\0631\0648\0641'');'),
'            }',
'        },',
...
unistr('                showError(''\0627\0633\062A\062C\0627\0628\0629 \063A\064A\0631 \0645\062A\0648\0642\0639\0629 \0645\0646 \0627\0644\062E\0627\062F\0645: '' + jqXHR.responseText.substring(0, 100));'),
'            } else {',
unistr('                showError(''\0641\0634\0644 \0627\0644\0627\062A\0635\0627\0644 \0628\0627\0644\062E\0627\062F\0645'');'),
'            }',
'        }',
'    }',
');',
'',
'function sendWhatsAppMessage(phoneNumber, bodyMessage) {',
'    try {',
'        var cleanPhone = phoneNumber.toString()',
'            .replace(/\s+/g, '''')',
'            .replace(/^\+/, '''')',
'            .replace(/[^0-9]/g, '''');',
'        ',
...
'        ',
'        if (typeof api_whatsapp_all_system !== ''undefined'' && ',
'            typeof api_whatsapp_all_system.sendMessage === ''function'') {',
'            ',
'            api_whatsapp_all_system.sendMessage(cleanPhone, bodyMessage);',
'            apex.message.showPageSuccess(''ok done send message'');',
'            ',
'        } else {',
'            var encodedMessage = encodeURIComponent(bodyMessage);',
'            var whatsappUrl = ''https://wa.me/'' + cleanPhone + ''?text='' + encodedMessage;',
'            ',
'            window.open(whatsappUrl, ''_blank'', ''noopener,noreferrer'');',
'            apex.message.showPageSuccess(''Open Whatsapp now to send the message'');',
'        }',
'    } catch (error) {',
'        console.error(''WhatsApp sending error:'', error);',
unistr('        showError(''\062E\0637\0623 \0641\064A \0625\0631\0633\0627\0644 \0627\0644\0631\0633\0627\0644\0629: '' + error.message);'),
'    }',
'}',
'',
...
wwv_flow_imp_page.create_page_process(
 p_id=>wwv_flow_imp.id(119819723019013185809)
,p_process_sequence=>10
,p_process_point=>'ON_DEMAND'
,p_process_type=>'NATIVE_PLSQL'
,p_process_name=>'GET_DATA_FOR_WHATSAPP'
...
'        p_order_id =>     APEX_APPLICATION.G_X01, ',
'        p_phone_number => l_phone_number,',
'        p_message_body => l_message_body',
'    );',
'    apex_json.initialize_output;',
'    APEX_JSON.OPEN_OBJECT;',
'    IF l_phone_number IS NOT NULL AND l_message_body IS NOT NULL THEN',
'        APEX_JSON.WRITE(''phone_number'', l_phone_number);',
'        APEX_JSON.WRITE(''message_body'', l_message_body);',
...
'        APEX_JSON.OPEN_OBJECT;',
'        APEX_JSON.WRITE(''error'', ''Order not found'');',
'        APEX_JSON.CLOSE_OBJECT;',
'    WHEN OTHERS THEN',
'        APEX_JSON.OPEN_OBJECT;',
...
,p_internal_uid=>119819723019013185809
);
end;
/
...
,p_required_patch=>wwv_flow_imp.id(119813421517557807443)
);
wwv_flow_imp_page.create_page_da_action(
